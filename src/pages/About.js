      ...
      <div className="grid md:grid-cols-2 gap-5">
        <div className=" flex flex-col justify-center  p-6">
          ...
          <p className="mb-3 indent-4">
            ...
            quibusdam aut commodi error, maxime ipsam eius accusamus, natus hic
            laborum. Cumque illum culpa excepturi autem quod hic animi, sequi
            quibusdam ab libero sint distinctio repellat, repudiandae at earum
            alias dolore architecto fugiat. Nihil, illo.
          </p>
          <p className="mb-3">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda
            neque ullam nostrum sed at placeat quibusdam aut commodi error,
