  ...
  return (
    <div>
      <Fade delay={100}>
        ...
        <div className="accordion grid grid-cols-2 gap-4" id="FAQaccordion">
      ...
      "
            ...
            >
              <div className="accordion-body text-lg py-4 px-5">
                <strong>This is the seventh item's accordion body.</strong> It
      ...
      "
              ...
              >
                <span className="mr-2 text-3xl text-gray-400">11:</span>Question
                goes here
              </button>
            </h2>
            <div
            ...
            >
              <div className="accordion-body text-lg py-4 px-5">
                <strong>This is the Eleventh item's accordion body.</strong> It
                is hidden by default, until the collapse plugin adds the
                appropriate classNamees that we use to style each element. These
                classNamees control the overall appearance, as well as the
                showing and hiding via CSS transitions. You can modify any of
      ...
      "
              ...
              >
                <span className="mr-2 text-3xl text-gray-400">12:</span>Question
                goes here
              </button>
            </h2>
            <div
            ...
            >
              <div className="accordion-body text-lg py-4 px-5">
                <strong>This is the Twelveth item's accordion body.</strong> It
                is hidden by default, until the collapse plugin adds the
                appropriate classNamees that we use to style each element. These
                classNamees control the overall appearance, as well as the
                showing and hiding via CSS transitions. You can modify any of
      ...
      "
              ...
              >
                <span className="mr-2 text-3xl text-gray-400">13:</span>Question
                goes here
              </button>
            </h2>
            <div
            ...
            >
              <div className="accordion-body text-lg py-4 px-5">
                <strong>This is the Thirteenth item's accordion body.</strong>{" "}
      ...
      "
              ...
              >
                <span className="mr-2 text-3xl text-gray-400">14:</span>Question
                goes here
              </button>
            </h2>
            <div
            ...
            >
              <div className="accordion-body text-lg py-4 px-5">
                <strong>This is the Fourteenth item's accordion body.</strong>{" "}
                It is hidden by default, until the collapse plugin adds the
                appropriate classNamees that we use to style each element. These
                classNamees control the overall appearance, as well as the
                showing and hiding via CSS transitions. You can modify any of
